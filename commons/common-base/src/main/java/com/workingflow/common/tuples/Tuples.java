...
public class Tuples {
    ...
    public static Function<Integer, Object> asFunction(final CartesianProduct product) {
    ...
    public static <P extends CartesianProduct> P asCartessianProduct(Object[] array) {
        if (array.length == 0) {
            return (P) tuple();
        }
        if (array.length == 1) {
            return (P) tuple(array[0]);
        }
        return (P) asTuple(array);
    }

    public static Object asTuple(Object[] array) {
    ...
    public static <P extends CartesianProduct> Function<Object[], P> asCartesianProductFunction() {

        return new Function<Object[], P>() {
            public P apply(Object[] array) {
                return asCartessianProduct(array);
            }
        };
    }
    public static Function<Object[], Object> asTupleFunction() {

        return new Function<Object[], Object>() {
            public Object apply(Object[] array) {
                return asTuple(array);
            }
        };
    }
}
